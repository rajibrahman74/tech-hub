...
const FeaturedJobsDetails = ({ fj }) => {
  ...
  return (
    <div className="w-[100%] md:w-[612px] rounded-lg border border-gray-300 mx-auto py-10 pl-10 relative">
      ...
      <button className="px-4 py-2.5 flex justify-center items-center font-bold text-base rounded-[4px] text-white bg-gradient-to-r from-blue-400 to-purple-600 absolute bottom-0 mb-5">
        View Details
      </button>
    </div>
  );
